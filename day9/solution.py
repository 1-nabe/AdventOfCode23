...
if __name__ == "__main__":
    ...
    # Extrapolated future sum: 1955513104
    print(f"Part 1 - Extrapolated future sum: {extrapolate(lines)}")
    # Extrapolated past sum: 1131
    print(
        f"Part 2 - Extrapolated past sum: {extrapolate([list(reversed(line)) for line in lines])}")
    # Finished in: 0.008111s
